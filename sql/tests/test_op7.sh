...
python -m backend.run_operation 7 --admin_id 1 --action list_available --date 2026-06-01 --start_time 14:00 --end_time 15:00
echo ""
echo "--- FAILURE: Assign room 4 to session 17 at 08:30-09:30 (conflicts with session 16 at 08:00-09:00 in room 4) ---"
python -m backend.run_operation 7 --admin_id 1 --action modify --target session --target_id 17 --room_id 4 \
